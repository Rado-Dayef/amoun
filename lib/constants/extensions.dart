...
extension NumbersExt on num {
  /// Loading.
  Widget get lightLoading => LoadingAnimationWidget.waveDots(size: toDouble(), color: AppColors.whiteColor);

  Widget get darkGoldLoading => LoadingAnimationWidget.waveDots(size: toDouble(), color: AppColors.darkGoldColor);

  Widget get lightGoldLoading => LoadingAnimationWidget.waveDots(size: toDouble(), color: AppColors.lightGoldColor);
...
extension TextExt on String {
  /// Toast.
  Future<bool?> get showToast => Fluttertoast.showToast(msg: this, textColor: AppColors.whiteColor, backgroundColor: AppColors.darkNbetyColor, fontAsset: AppStrings.elMessiriFont);
}
